...
if ( isset($_POST['email']) && isset($_POST['pass']) )
{
    ...
    try
    {
        $pdo = new PDO("mysql:host=localhost;dbname=coursera_javascript_jquery_and_json", "root", "");
...
<html>
    <head>
        <title>Meghna Dutta's Login Page</title>
    ...
    <body>
        <div class="container">
            ...
            <p>
                ...
                <!-- Hint: The password is the programming language used here (all lower case) followed by 123. -->
            </p>
        </div>
